...
@section('content')
                   ...
                   <h2 class="title text-center">Category Wase Product</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											<img src="{{URL::to($v_product_by_category->product_image)}}" alt="" style="height: 300px"/>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<img src="{{URL::to($v_product_by_category->product_image)}}" alt="" style="height: 300px; width:250px"/>
												<h2>{{ $v_product_by_category->product_price}} Tk</h2>
												<p>{{ $v_product_by_category->product_name}}</p>
												<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart" ></i>Add to cart</a>
											</div>
