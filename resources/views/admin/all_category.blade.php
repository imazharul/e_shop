				...
				<div class="box span12">
					...
					<div class="box-content">
						<table id="datatableid" class="table table-striped table-bordered bootstrap-datatable datatable display">
							{{-- <div>
								<form action="/seacrh" method="GET">
								<input type="seacrh" name="seacrh" class="form-control"> <input class="btn btn-success" type="submit" value="Seache">
								</form>
							</div> --}}
						  <thead>
							  <tr>
					...
					@foreach ($allcategoryinfo as $v_category)
						 
					    <tbody>
							<tr>
								<td>{{ $v_category->category_id }}</td>
								<td class="center">{{ $v_category->category_name }}</td>
								<td class="center">{{ $v_category->category_discription }}</td>
							...
							<td class="center">
								...
								@if($v_category->publication_satus==1)
							<a class="btn btn-danger" href="{{URL::to('/unactive',$v_category->category_id)}}">
								...
								<a class="btn btn-info" href="{{URL::to('/edit',$v_category->category_id)}}">
									...
									<a class="btn btn-danger" href="{{URL::to('/delete',$v_category->category_id)}}" id="delete">
