					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 01676179333</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> imazharul545@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
			...
			<div class="col-sm-12">
				<div id="slider-carousel" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
						<?php
							$all_published_slider=DB::table('slide')
												->where('slider_publication_status',1)
												->get();
								$i=1;	
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--Manufacture or brands products-->
						...
						</div><!--/end Manufactur or brands_products-->
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
                        ...
                        @yield('content') <!--add home_content.blade page-->
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<p> <strong> Our Top delevary man </p> 
						</div>
					</div>
					<div class="col-sm-8">
						<?php 
					$all_publicdalibaryman = DB::table('dalibaryman')
						->where('status',1)
						->get();
						foreach ($all_publicdalibaryman as $v_dalibariman) {?>

						<div class="col-sm-3">
							<div class="video-gallery text-center">
										<a href="#">
											<div class="iframe-img">
												<img src="{{URL::to($v_dalibariman->dalibaryman_image)}}" alt="" />
											</div>
											<div class="overlay-icon">
												<i class="fa fa-play-circle-o"></i>
											</div>
										</a>
										<h2><strong>name : {{$v_dalibariman->dalibaryman_name}}</h2>
										<h2>Information :{{$v_dalibariman->dalibaryman_description}}</h2>
							</div>
						</div>
						<?php } ?>
					</div>
